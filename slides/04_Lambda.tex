...
\begin{frame}{Normalreihenfolge}
	...
	\begin{itemize}
		...
		\item Bindet \texttt{LambdaShow} ein für \texttt{Show LambdaTerm}
	\end{itemize}
\end{frame}
...
\begin{frame}{Church-Zahlen}
	\begin{itemize}
		...
		\begin{itemize}
                  \item \href{https://pp.ipd.kit.edu/lehre/misc/lambda-ide/Wavelength.html}{pp.ipd.kit.edu/lehre/misc/lambda-ide/Wavelength.html}
		\end{itemize}
	\end{itemize}
\end{frame}
...
\begin{frame}{Cheatsheet: Lambda-Kalkül/Basics}
  \begin{itemize}
    ...
    \item \emph{Church-Booleans}, \emph{Church-Zahlen}, \emph{Y-Kombinator}
  \end{itemize}
\end{frame}
